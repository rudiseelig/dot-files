...
brew install git nvm tmux reattach-to-user-namespace neovim ripgrep python python@2 heroku rbenv ruby-build fzf
...
git clone https://github.com/rudiseelig/dot-files ~/.etc/
